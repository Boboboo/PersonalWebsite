  ...
  <body>
    <!--Navigation Bar-->  
      <nav role="navigation" class="navbar navbar-custom navbar-fixed-top">
          <div class="container-fluid">
              <a class="navbar-brand" href="#"><img src="image/LogoCrown.png" class="logo"></a>
    ...
    <div class="jumbotron" id="myContainer">
        ...
        <div class="introduceme container">
            ...
            <h4><a href="https://drive.google.com/open?id=0B2An4EkYubiVM1c1RDRBTmlreXM" id="demo">RESUME</a> </h4>    
        </div>
